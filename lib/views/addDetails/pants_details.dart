...
class PantsDetails extends StatefulWidget {
  const PantsDetails({super.key, required this.pants});

  final String pants;

  @override
  State<PantsDetails> createState() => _PantsDetailsState();
}

class _PantsDetailsState extends State<PantsDetails> {
  File? _image;
  //File? _file;
  ...
  Future<dynamic> uploadImage() async {
    ...
    request.fields['type'] = widget.pants;
